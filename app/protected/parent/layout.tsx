...
const navItems = [
  { label: "Dashboard", href: "/protected/parent" },
  { label: "Settings", href: "/protected/parent/settings" },
];
...
export default function ParentLayout({
  ...
  useEffect(() => {
    ...
    setUserName(nameFromEmail ? nameFromEmail : "Parent");
  }, []);

  const activeHref = useMemo(() => {
    if (!pathname) return "/protected/parent";
    if (pathname.startsWith("/protected/parent/settings")) return "/protected/parent/settings";
        ...
        <div className="relative w-full px-4 sm:px-6 py-6">
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={() => router.push("/protected/parent/settings")}
