...
const navItems = [
  { label: "Dashboard", href: "/protected/admin" },
  { label: "Users", href: "/protected/admin/users" },
  { label: "Relationships", href: "/protected/admin/relationships" },
  { label: "Upload", href: "/protected/admin/upload" },
  { label: "Content", href: "/protected/admin/content" },
  { label: "Reports", href: "/protected/admin/reports" },
  { label: "Settings", href: "/protected/admin/settings" },
];
...
export default function AdminLayout({
  ...
  useEffect(() => {
    ...
    setUserName(nameFromEmail ? nameFromEmail : "Admin");
  }, []);

  const activeHref = useMemo(() => {
    if (!pathname) return "/protected/admin";
    if (pathname.startsWith("/protected/admin/users")) return "/protected/admin/users";
    if (pathname.startsWith("/protected/admin/relationships")) return "/protected/admin/relationships";
    if (pathname.startsWith("/protected/admin/upload")) return "/protected/admin/upload";
    if (pathname.startsWith("/protected/admin/content")) return "/protected/admin/content";
    if (pathname.startsWith("/protected/admin/reports")) return "/protected/admin/reports";
    if (pathname.startsWith("/protected/admin/settings")) return "/protected/admin/settings";
        ...
        <div className="relative w-full px-4 sm:px-6 py-6">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-purple-200 mt-1">Welcome, {userName}</p>
            </div>
